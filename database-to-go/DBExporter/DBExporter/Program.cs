...
namespace DBExporter
{
    public static class Program
    {
        public static void Main(string[] args)
        {
            ...
            var databaseBuilder = DatabaseBuilderFactory.Connect(options.DatabaseOptions.ServerTypes, options.DatabaseOptions.ConnectionString);
        ...
        {
            var writeFactory = exportOptions.ExportFormats switch
            {
            ...
            var dataWriter = writeFactory.GetDataWriter();
