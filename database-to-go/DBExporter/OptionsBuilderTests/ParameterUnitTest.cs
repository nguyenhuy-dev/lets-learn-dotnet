...
namespace OptionsBuilderTests
{
    public class ParameterUnitTest
    {
        ...
        public void ParseValidArgsTest(params string[] args)
        {
            ...
            {
                CurrentTimeFunc = () => new DateTime(2025, 09, 07, 23, 59, 59)
            };
            ...
            Assert.Equal(ServerTypes.SqlServer, options.DatabaseOptions.ServerTypes);
            ...
            Assert.Equal("filename-20250709-235959.csv.zip", options.ExportOptions.FileName);
        }
    }
}
